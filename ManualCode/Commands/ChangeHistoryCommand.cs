...
namespace CodeFlow.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ChangeHistoryCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        public const int CommandId = 8200;
        ...
        /// </summary>
        public static ChangeHistoryCommand Instance
        {
            get;
            private set;
        }
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(ChangeHistory), 0, true);
